...
<!-- MAIN SLIDER -->
    <section class="main-slider" data-loop="true" data-autoplay="true" data-interval="7000">
      <div class="inner">
        ...
        <!-- Slide One -->
        <div class="slide slideResize slide1" style="background-image: url(http://placehold.it/1920x800);">
          <div class="container">
        ...
        <!-- Slide Two -->
        <div class="slide slideResize slide2" style="background-image: url(http://placehold.it/1920x800);">
          <div class="container">
        ...
        <!-- Slide Three -->
        <div class="slide slideResize slide3" style="background-image: url(http://placehold.it/1920x800);">
          <div class="container">
        ...
        <!-- Slide Four -->
        <div class="slide slideResize slide4" style="background-image: url(http://placehold.it/1920x800);">
          <div class="container">
